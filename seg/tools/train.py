...
def main():
    ...
    #     cfg.val_dataloader.dataset.pipeline = cfg.tta_pipeline
    #     cfg.work_dir = cfg.work_dir + '_tta'
    ...
    print(f'total  param: {total_params/1e6}')
    print(f'total trainable param: {trainable_params/1e6}')
    # start training
    runner.train()
